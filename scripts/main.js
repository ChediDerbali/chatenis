...
function FriendlyChat() {
  ...
  this.isSigned = document.getElementById('signed');
  this.isNotSigned = document.getElementById('not-signed');
...
FriendlyChat.prototype.onAuthStateChanged = function (user) {
  if (user) { // User is signed in!
    ...
    this.isSigned.removeAttribute('hidden');

    // Hide sign-in button.
    this.isNotSigned.setAttribute('hidden', 'true');
    ...
    this.isSigned.setAttribute('hidden', 'true');
    // Show sign-in button.
    this.isNotSigned.removeAttribute('hidden');
